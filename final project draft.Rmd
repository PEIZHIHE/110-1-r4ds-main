...
Line29 dataset路徑麻煩同學們手動改成自己的存擋位置，謝謝。
（為了省事所以不弄到googlesheet上）

```{r}
library(readr)
library(dplyr)
library(ggplot2)
dataset <- read_csv("/Users/peizhi/Documents/OneDrive/final project/dataset.csv", show_col_types = FALSE)
```
